  ...
  return (
    ...
    >
      <div className="log-panel-header">
        <h2>Time Logs</h2>
        <span className="today-total-badge">Today: {formatDuration(totalToday)}</span>
      </div>
            ...
            {logs.map((log) => (
              ...
              >
                <div className="log-info-left">
                  <div className="log-task-name">{log.task}</div>
                  <div className="log-date-label">{log.date}</div>
                </div>
                <div className="log-meta-right">
                  <div className="log-duration-val">{formatDuration(log.duration)}</div>
                  <button 
